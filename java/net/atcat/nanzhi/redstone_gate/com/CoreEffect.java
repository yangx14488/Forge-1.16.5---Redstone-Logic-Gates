...
public class CoreEffect extends Effect {
    ...
    public static void eventAdd( PotionEvent.PotionAddedEvent event ) {
        ...
        if ( effect.getEffect( ) instanceof CoreEffect ) {
            if ( old == null || old.getAmplifier() < effect.getAmplifier( ) ) {
                ( (CoreEffect) ( effect.getEffect( ) ) ).onAdded( event.getEntityLiving( ), effect, old );
            }
            ;
        }
    }
    ...
    public static void eventRemove( PotionEvent.PotionRemoveEvent event ) {
        EffectInstance effect = event.getPotionEffect( ) ;
        if ( effect != null && effect.getEffect( ) instanceof CoreEffect )  {
            ( (CoreEffect) ( effect.getEffect( ) ) ).onRemove( event.getEntityLiving( ), effect );
        }
    }
    // 自然消失
    @SubscribeEvent
    public static void eventExpiry( PotionEvent.PotionExpiryEvent event ) {
        ...
        if ( effect != null && effect.getEffect( ) instanceof CoreEffect )  {
            ...
            ( (CoreEffect) ( effect.getEffect( ) ) ).onExpiry( event.getEntityLiving( ), effect ) ;
        }
    }
